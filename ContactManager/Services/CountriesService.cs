...
public class CountriesService: ICountriesService
{
    ...
    public CountriesService(ContactMangerDbContext dbContext)
    {
    ...
    public CountryResponse AddCountry(CountryAddRequest? countryAddRequest)
    {
        ...
        if (_dbContext.countries.Any(temp => temp.CountryName == countryAddRequest.CountryName))
        {
    ...
    public CountryResponse? GetCountryByCountryId(Guid? countryId)
    {
        ...
        Country? country = _dbContext.countries.FirstOrDefault(temp => temp.CountryId == countryId);
